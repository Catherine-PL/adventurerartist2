...
*/}
            ...
            <h1
              ref={textTwo}
              className="text-neutral-400 text-center text-2xl p-1 tablet:p-2 text-bold w-full laptop:w-5/5"
            >
...
{/*
        ...
        <div className="mt-10 laptop:mt-30 p-2 laptop:p-0" ref={workRef}>
          <h1 className="text-2xl text-bold">Featured blog posts.</h1>
        ...
        <div className="mt-10 laptop:mt-30 p-2 laptop:p-0">
          <h1 className="tablet:m-10 text-2xl text-bold">Areas of interest.</h1>
